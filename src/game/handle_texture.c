...
/*   Updated: 2025/04/01 17:26:40 by ncharbog         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_texture(t_data *data)
{
	...
	img[NO].addr = mlx_get_data_addr(img[NO].img, &img[NO].bpp,
			&img[NO].size_line, &img[NO].endian);
	img[SO].addr = mlx_get_data_addr(img[SO].img, &img[SO].bpp,
			&img[SO].size_line, &img[SO].endian);
	img[WE].addr = mlx_get_data_addr(img[WE].img, &img[WE].bpp,
			&img[WE].size_line, &img[WE].endian);
	img[EA].addr = mlx_get_data_addr(img[EA].img, &img[EA].bpp,
			&img[EA].size_line, &img[EA].endian);
	img[4].addr = NULL;
}
